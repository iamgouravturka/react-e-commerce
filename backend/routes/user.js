...
const { register, login, logout, forgotPassword, resetPassword, getMyProfile, updatePassword, updateProfile, getUserDetail, updateRole, deleteUser, getAllUsers } = require("../controllers/user");
